...
const Map<String, Map<String, String>> _translations = {
  'en': {
    ...
    'login.tagline': 'Transparent • Efficient • For a Better Tomorrow',
    ...
    'login.verify_login_btn': 'Verify OTP & Login',
    ...
    'login.get_otp_btn': 'Get Verification OTP',
  ...
  'hi': {
    ...
    // Login Screen Comprehensive
    'login.tagline': 'पारदर्शी • कुशल • बेहतर कल के लिए',
    ...
    'login.verify_login_btn': 'OTP सत्यापित करें और लॉगिन करें',
    ...
    'login.get_otp_btn': 'सत्यापन OTP प्राप्त करें',
  ...
  'kn': {
    ...
    'login.verify_login_btn': 'OTP ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಲಾಗಿನ್ ಆಗಿ',
    ...
    'login.get_otp_btn': 'ಪರಿಶೀಲನಾ OTP ಪಡೆಯಿರಿ',
