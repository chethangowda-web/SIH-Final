...
class DsoService {
  ...
  Future<DsoCommandOverview> getCommandOverview({
    ...
    final res = await _client.get(uri, headers: _getHeaders());
  ...
  Future<Map<String, dynamic>> validateDemand({
    ...
    final res = await _client.post(uri, headers: _getHeaders(), body: body);
    if (res.statusCode == 200) {
      return json.decode(res.body) as Map<String, dynamic>;
    } else {
  ...
  Future<Map<String, dynamic>> approveAllocation({
    ...
    final res = await _client.post(uri, headers: _getHeaders());
    if (res.statusCode == 200) {
      return json.decode(res.body) as Map<String, dynamic>;
    } else {
